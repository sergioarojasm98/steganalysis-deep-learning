...
def train_model():
    ...
    conv5 = Conv2D(256, kernel_size=(3, 3), activation="relu")(pool4)
    norm5 = BatchNormalization()(conv5)
    pool5 = MaxPooling2D(pool_size=(2, 2))(norm5)
    flat5 = Flatten()(pool5)

    # Concatenar la salida aplanada de la primera y quita capa
    concat = concatenate([flat1, flat5])
