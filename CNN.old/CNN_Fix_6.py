...
def plot_far_frr(y_true, y_pred_prob):
    ...
    script_name = os.path.basename(__file__).split(".")[0]
    file_path = os.path.join(
        "/home/srojas/tg2/Resultados/", f"FAR_FRR_{script_name}.png"
    )
...
def test_best_model():
    ...
    message = "[CRATOS] Evaluación con el conjunto de Test:\n"
...
def metrics_best_model():
    ...
    message = "[CRATOS] Metricas extra con el conjunto de Test:\n"
    message += f"MCC: {mcc_value:.4f}\n"
